        ...
        <div className=''>
            ...
            <div className='container px-8 mx-auto my-8'>
                <div className='flex flex-col md:flex-row my-5'>
                    <img className='w-full md:w-1/2' src='http://definitiontech.co/wp-content/uploads/2018/06/CORS_SameOrginPolicy-768x342.jpg'></img>
                ...
                <div className='flex flex-col md:flex-row my-5'>
                    <img className='w-full md:w-1/2' src='https://crowdbotics.ghost.io/content/images/2019/07/react-router.jpg'></img>
                    <div className='w-full md:w-2/3 my-4 md:my-0 text-left md:mx-5'>
                ...
                <div className='flex flex-col md:flex-row my-5'>
                    <img className='w-full md:w-1/2' src='https://res.cloudinary.com/practicaldev/image/fetch/s--XnV7nLnZ--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://thepracticaldev.s3.amazonaws.com/i/cufhvx44o66bb32ll2l8.png'></img>
                    <div className='w-full md:w-2/3 my-4 md:my-0 text-left md:mx-5'>
